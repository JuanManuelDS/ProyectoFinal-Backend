...
public class Constants {
	...
	public static final String EMAIL_VALIDATION_URL = "api/validacion/email_tomado/{email}";
	public static final String USERNAME_VALIDATION_URL = "api/validacion/username_tomado/{username}";
