...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
		...
		//Retorno los roles del usuario principal y los convierto a un string
		...
		String token = Jwts.builder()
				...
				.setIssuer(ISSUER_INFO) //Agrego la información del creador 
				...
				.signWith(SignatureAlgorithm.HS512, SUPER_SECRET_KEY).compact(); //Lo firmo con el algoritmo HS512 y la firma secreta
